...
amount of logging information to display. %TODO første del lidt derp?
...
should be printed. The message level are {\tt error}, {\tt warning} and {\tt
  info}.
% TODO burde der ikke være et ``none'' level og burde log level og msg level
...
the logging macros. %TODO forvirrende
...
string- and constants table. As for the reasons explained in TODO. %XXX
...
%TODO ^ stod der ikke tidligere at Modified UTF8 ikke var null terminated?
...
%  Unfortunately, due
% to the same reasons as with the constant and string tables, this has not been
...
% There are special instruction for creating heap objects, where {\tt box} is
% one of them. TODO: explained elsewhere?
