...
members of \code{am\_state} are a reference to the code bytes and a reference to
the main thread. These are both values that will not change during the entire
