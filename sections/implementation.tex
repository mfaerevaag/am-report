...
\textit{The Engine} module is the top-most control unit that is used to set
...
\textit{Abstract Machine} module is responsible for reading and the byte code,
...
data structures and exposes an interface for push, popping, replacing and
...
\item Initialize main thread
  \begin{enumerate}
  \item Allocate an actual thread
  \item Allocate stack
  \end{enumerate}
