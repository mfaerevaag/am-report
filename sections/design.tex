...
%TODO garbage collector details (the interface)
...
and harder to shoot yourself in the foot. Dynamic scoping has more or less
disappeared from language implementation\cite{cse341}.
...
\item[\instr{pushMeta}:]
  ...
  information. The \instr{pushMeta} takes an index into the meta data table and
