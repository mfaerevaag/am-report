...
often written for a particular processor architecture. Nowadays only the most
domain specific languages can make due with that. Any language that desires
...
multitude of programming languages of different paradigms. The system exposes
...
Section~\ref{sec:evaluation} and Section~\ref{sec:further-development} evaluates
the status of the project and discusses what the next steps towards a better
product are.

Section~\ref{sec:related-work} presents some related work from which we have
drawn inspiration and finally Section~\ref{sec:project-management} describe how
we have managed the project, both technically and personally.
