...
% TODO something about circular deps in ref counting
...
actual use it is critical that the garbage collector works.
...
of some op-code prefixes. For instance \code{vtable} and \code{static} cannot be
composed and \code{unsafe} must directly proceed the instruction op-code.
