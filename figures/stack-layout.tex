\begin{tikzpicture}[scale=.8]
  ...
  % Segments
  \drawstruct{(-10,0)}
  \structcell[freecell]{\code{size}}         \coordinate (seg_start) at (-8.4,\value{structnb});
  \structcell[freecell]{\code{length}}
  \structcell[freecell]{\code{content}}      \coordinate (seg_content) at (-8.4,\value{structnb});
  \structcell[freecell]{\code{head}}         \coordinate (seg_head) at (-8.4,\value{structnb});
